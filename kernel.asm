...
80106d27:	8d 1c 40             	lea    (%eax,%eax,2),%ebx
80106d2a:	c1 e3 02             	shl    $0x2,%ebx
80106d2d:	8b 83 f8 54 11 80    	mov    -0x7feeab08(%ebx),%eax
80106d33:	8d b8 00 00 00 80    	lea    -0x80000000(%eax),%edi
80106d39:	e8 72 c9 ff ff       	call   801036b0 <myproc>
80106d3e:	8b 30                	mov    (%eax),%esi
80106d40:	e8 6b c9 ff ff       	call   801036b0 <myproc>
80106d45:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106d4c:	00 
80106d4d:	89 7c 24 0c          	mov    %edi,0xc(%esp)
80106d51:	81 c6 ff 0f 00 00    	add    $0xfff,%esi
80106d57:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
80106d5d:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106d64:	00 
80106d65:	89 74 24 04          	mov    %esi,0x4(%esp)
80106d69:	8b 40 04             	mov    0x4(%eax),%eax
80106d6c:	89 04 24             	mov    %eax,(%esp)
80106d6f:	e8 dc f7 ff ff       	call   80106550 <mappages>
      shm_table.shm_pages[i].refcnt++;
80106d74:	83 83 fc 54 11 80 01 	addl   $0x1,-0x7feeab04(%ebx)
      //pointer=virtual adress
      //*pointer=(char *) PGROUNDUP(myproc()->sz);
      v= ((char*)PGROUNDUP(myproc()->sz));
80106d7b:	e8 30 c9 ff ff       	call   801036b0 <myproc>
      pointer=v;
      //*pointer = (char*)shm_table.shm_pages[i].frame;
      release(&(shm_table.lock));
80106d80:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106d87:	e8 b4 d4 ff ff       	call   80104240 <release>
    }
...
80106d8c:	83 c4 2c             	add    $0x2c,%esp
...
80106d94:	5d                   	pop    %ebp
80106d95:	c3                   	ret    
80106d96:	66 90                	xchg   %ax,%ax
  for (; i< 64; i++)
80106d98:	ba f4 54 11 80       	mov    $0x801154f4,%edx
80106d9d:	30 c0                	xor    %al,%al
80106d9f:	eb 12                	jmp    80106db3 <shm_open+0xc3>
80106da1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
   for(pos=0;pos<64;pos++)
80106da8:	83 c0 01             	add    $0x1,%eax
80106dab:	83 c2 0c             	add    $0xc,%edx
80106dae:	83 f8 40             	cmp    $0x40,%eax
80106db1:	74 65                	je     80106e18 <shm_open+0x128>
    if(shm_table.shm_pages[pos].id==0)
80106db3:	8b 0a                	mov    (%edx),%ecx
80106db5:	85 c9                	test   %ecx,%ecx
80106db7:	75 ef                	jne    80106da8 <shm_open+0xb8>
      shm_table.shm_pages[pos].id=id; //initialize its id to the id passed in
80106db9:	8d 34 40             	lea    (%eax,%eax,2),%esi
80106dbc:	c1 e6 02             	shl    $0x2,%esi
80106dbf:	89 9e f4 54 11 80    	mov    %ebx,-0x7feeab0c(%esi)
      shm_table.shm_pages[pos].frame = kalloc();
80106dc5:	e8 e6 b6 ff ff       	call   801024b0 <kalloc>
      memset(shm_table.shm_pages[pos].frame , 0, PGSIZE);
80106dca:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106dd1:	00 
80106dd2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106dd9:	00 
80106dda:	89 04 24             	mov    %eax,(%esp)
      shm_table.shm_pages[pos].frame = kalloc();
80106ddd:	89 86 f8 54 11 80    	mov    %eax,-0x7feeab08(%esi)
      memset(shm_table.shm_pages[pos].frame , 0, PGSIZE);
80106de3:	e8 a8 d4 ff ff       	call   80104290 <memset>
      v=(char *) PGROUNDUP(myproc()->sz);
80106de8:	e8 c3 c8 ff ff       	call   801036b0 <myproc>
      myproc()->sz+= PGSIZE;
80106ded:	e8 be c8 ff ff       	call   801036b0 <myproc>
80106df2:	81 00 00 10 00 00    	addl   $0x1000,(%eax)
      release(&(shm_table.lock));
80106df8:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
      shm_table.shm_pages[pos].refcnt=1;
80106dff:	c7 86 fc 54 11 80 01 	movl   $0x1,-0x7feeab04(%esi)
80106e06:	00 00 00 
      release(&(shm_table.lock));
80106e09:	e8 32 d4 ff ff       	call   80104240 <release>
}
80106e0e:	83 c4 2c             	add    $0x2c,%esp
...
80106e17:	c3                   	ret    
  release(&(shm_table.lock));
80106e18:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106e1f:	e8 1c d4 ff ff       	call   80104240 <release>
  return 0;
80106e24:	e9 63 ff ff ff       	jmp    80106d8c <shm_open+0x9c>
...
80106e4d:	eb 0c                	jmp    80106e5b <shm_close+0x2b>
80106e4f:	90                   	nop
80106e50:	83 c0 01             	add    $0x1,%eax
80106e53:	83 c2 0c             	add    $0xc,%edx
80106e56:	83 f8 40             	cmp    $0x40,%eax
80106e59:	74 1d                	je     80106e78 <shm_close+0x48>
  {
    //CASE ID exist
    if(shm_table.shm_pages[i].id==id)//if it finds id in table
80106e5b:	39 1a                	cmp    %ebx,(%edx)
80106e5d:	75 f1                	jne    80106e50 <shm_close+0x20>
    {
       shm_table.shm_pages[i].refcnt-=1;
80106e5f:	8d 0c 40             	lea    (%eax,%eax,2),%ecx
80106e62:	c1 e1 02             	shl    $0x2,%ecx
       if(shm_table.shm_pages[i].refcnt==0)
80106e65:	83 a9 fc 54 11 80 01 	subl   $0x1,-0x7feeab04(%ecx)
80106e6c:	75 0a                	jne    80106e78 <shm_close+0x48>
        shm_table.shm_pages[i].id=0;
80106e6e:	c7 81 f4 54 11 80 00 	movl   $0x0,-0x7feeab0c(%ecx)
80106e75:	00 00 00 
       release(&(shm_table.lock));
80106e78:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106e7f:	e8 bc d3 ff ff       	call   80104240 <release>
    }
  }
  release(&(shm_table.lock));
...
80106e84:	83 c4 14             	add    $0x14,%esp
80106e87:	31 c0                	xor    %eax,%eax
80106e89:	5b                   	pop    %ebx
80106e8a:	5d                   	pop    %ebp
80106e8b:	c3                   	ret    
